...
namespace jwt.Controllers {
    ...
    public class RolesController : BaseApiController {
       ...
       [Route("GetAllRoles")]
        ...
        // the method “ManageUsersInRole” is proprietary for the AngularJS app which we’ll build in the coming posts,
        // this method will accept a request body containing an object of type “UsersInRoleModel” where the application 
        // will add or remove users from a specified role.


       [Route("ManageUsersInRole")]
        public async Task<IHttpActionResult> 
            ManageUsersInRole(UsersInRoleModel model) {
